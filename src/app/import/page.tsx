...
function ImportForm() {
  ...
  return (
    <div className="min-h-screen bg-[#0f172a] px-4 py-8 pb-24">
      <div className="mx-auto max-w-lg">
        {/* Header */}
        <div className="mb-6">
          <Link
        ...
        {importResult?.success && (
          <div className="mb-6 p-4 bg-green-900/30 border border-green-800 rounded-lg">
            ...
            <Link
              ...
              className="inline-block text-sm text-green-400 hover:text-green-300 font-medium"
            >
        ...
        <div className="space-y-6">
          ...
          <div className="bg-slate-800 rounded-lg p-4">
            ...
            <select
              ...
              className="w-full px-3 py-2 bg-slate-700 border border-slate-600 text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500"
            >
            ...
            {!file ? (
              ...
              >
                ...
                <label className="inline-block cursor-pointer">
                  <span className="px-4 py-2 bg-slate-700 hover:bg-slate-600 text-white rounded-md transition-colors">
                    Browse Files
                  </span>
                  <input
                    type="file"
          ...
          <div className="bg-slate-800/50 rounded-lg p-4">
            ...
            <p className="text-xs text-gray-400 mb-2">
              Required columns: <span className="text-gray-300">date, gallons, pricePerGallon, odometer</span>
            </p>
            <p className="text-xs text-gray-400">
              Optional columns: <span className="text-gray-300">isFull, notes, city, state, country, latitude, longitude</span>
            </p>
            <div className="mt-3 p-2 bg-slate-900 rounded text-xs font-mono text-gray-400 overflow-x-auto">
        ...
        <div className="fixed bottom-16 md:bottom-0 left-0 right-0 p-4 bg-slate-900 border-t border-slate-700">
          <div className="max-w-lg mx-auto">
            <button
              ...
              disabled={!canImport}
              className="w-full py-4 px-4 bg-green-600 hover:bg-green-700 text-white text-lg font-semibold rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 focus:ring-offset-slate-900 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
            >
